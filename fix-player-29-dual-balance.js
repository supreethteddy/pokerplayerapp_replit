...
async function fixPlayer29DualBalance() {
  try {
    ...
    const response = await fetch('http://localhost:5000/api/players/supabase/e0953527-a5d5-402c-9e00-8ed590d19cde');
    ...
    console.log('✅ [TEST] API Response:', {
      ...
      realBalance: apiData.realBalance,
      creditBalance: apiData.creditBalance,
      creditLimit: apiData.creditLimit,
      creditApproved: apiData.creditApproved
    });
