...
- **Guest Relations (GRE) Chat**: Real-time bidirectional chat functionality integrated into the feedback tab, allowing players to communicate with staff, with messages stored in the Staff Portal Supabase.
