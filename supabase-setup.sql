-- SUPABASE SETUP - ROBUST VERSION
-- This handles all edge cases and creates a clean database
...
-- Step 4: Create tables for poker rooms
CREATE TABLE tables (
    id SERIAL PRIMARY KEY,
    name TEXT NOT NULL,
...
-- Step 5: Create seat requests table
...
-- Step 6: Create KYC documents table
...
-- Step 9: Insert the 9 players from Neon database
...
-- Step 10: Create poker tables for staff portal integration
...
-- Step 13: Insert sample KYC documents for staff review
...
-- Step 14: Insert sample transactions for admin portal
...
SELECT 'SUPABASE SETUP COMPLETE - ALL PORTALS READY' as status;
